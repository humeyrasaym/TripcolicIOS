...
class FeedViewController: UIViewController {
    ...
    private func createMockModels(){
        let user = User(username: "anilovic",
                   bio: "",
                   name: (first: " ", last: " "),
...
extension FeedViewController: IGFeedPostHeaderTableViewCellDelegate {
...
extension FeedViewController: IGFeedPostActionsTableViewCellDelegate {
